...
class UserInfo {
  ...
  static UserProfilModel userProfil = const UserProfilModel(uuid: '', firstname: '', lastname: '', username: '', diploma: '', formation: '', biography: '', followers: [], following: [], pfpPath: '', bannerPath: '');
